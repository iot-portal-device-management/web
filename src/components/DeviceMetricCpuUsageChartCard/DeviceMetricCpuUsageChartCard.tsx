...
interface DeviceMetricCpuUsageChartCardProps {
  deviceId: string;
}

const DeviceMetricCpuUsageChartCard = ({ deviceId }: DeviceMetricCpuUsageChartCardProps) => {
...
export default DeviceMetricCpuUsageChartCard;
